                                ...
                                <div class="col-lg-12">
                                    <form role="form" method="post" action="../../Controlador/especialistaController.php?action=editar">
                                        <div class="form-group">
                                            <label>Nombres</label>
                                            <input required value="<?php echo $ObjEspecialista->getNombres(); ?>" data-toggle="tooltip" title="Sin Signos de puntuación o caracteres especiales" data-placement="top" maxlength="60" id="Nombres" name="Nombres" minlength="2" class="form-control newTooltip" placeholder="Ingrese Sus Nombres Completos">
                                        </div>
                                        <div class="form-group">
                                            <label>Apellidos</label>
                                            <input required value="<?php echo $ObjEspecialista->getApellidos(); ?>" maxlength="60" id="Apellidos" name="Apellidos" minlength="2" class="form-control" placeholder="Ingrese Sus Apellidos Completos">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion</label>
                                            <input required value="<?php echo $ObjEspecialista->getDireccion(); ?>" maxlength="60" id="Direccion" name="Direccion" minlength="7" class="form-control" placeholder="Ingrese su direccion de residencia">
                                        </div>
