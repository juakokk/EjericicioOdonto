                            ...
                            <div id="alertas">
                                <?php if(!empty($_GET["respuesta"]) && $_GET["respuesta"] == "correcto"){ ?>
                                    <div class="alert alert-success alert-dismissable">
                                        ...
                                        La informacion del Especialista se ha registrado correctamente. Puede administrar los Especialistas desde <a href="adminEspecilista.php" class="alert-link">Aqui</a> .
                                    </div>
                                <?php } ?>
